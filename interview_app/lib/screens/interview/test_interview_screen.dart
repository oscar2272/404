...
class _TestInterviewScreenState extends State<TestInterviewScreen> {
  ...
  List<BubbleNormalWidget> messages = [
    ...
    const BubbleNormalWidget(
      text:
          "[ 모의면접 평가 ]\n1. 발화의도 : 현재 지원자님의 발화의도는 간절함이 보이는것 같습니다.\n2. 성장가능성 : 착실한 학교 생활을 통해 미래에도 많은 성공 가능성을 이룰 것을 확신합니다.\n3. 논리적 표현 : 답변 사항 중 문제를 해결하기 위한 논리적 표현이 인상 깊었습니다.\n4. 인성 : 평소 봉사활동을 통해 남을 위한 봉사정신이 앞으로의 회사 생활을 이끌어줄 것 같습니다.\n5. 전문지식 : 간단한 지식 기술 기반 문제에 대한 답을 확실히 하여 해결하는 방향성이 높은 평가를 추구합니다.\n\n최종 점수 : 88% / 합격 ",
      isSender: false,
      color: Color(0xFFE8E8EE),
      tail: true,
      textColor: Colors.black,
